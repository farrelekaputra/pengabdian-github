    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: rgba(224,224,224);">
        ...
        >
            <div class="menu me-4" style="cursor:pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="white" class="bi bi-list-ul" viewBox="0 0 16 16">
    ...
    <!-- container body -->
      <div class="container bg-tertiary">
        ...
        <div class="Sidebar d-flex flex-column flex-shrink-0 p-3 rounded">
            ...
            <li class="nav-item">
                <a href="#" class="Home nav-link fw-bolder mb-1 mt-2" style="display: flex; background-color: rgb(49, 134, 41);">
            ...
            <li>
                <a href="karyawan.html" class="nav-link link-dark fw-bolder mb-1 mt-2" style="display: flex;">
            ...
            <li>
                <a href="monitoring.html" class="nav-link link-dark fw-bolder mb-1 mt-2" style="display: flex;">
            ...
            <li>
                <a href="panen.html" class="nav-link link-dark fw-bolder mb-1 mt-2" style="display: flex;">
