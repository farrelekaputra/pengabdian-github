...
<div class="Sidebar d-flex flex-column flex-shrink-0 p-3 rounded">
            ...
            <li>
                ...
                <div class="icon font-s"><i class="bi bi-person"></i></div>
                <label for="labelHome" class="ps-2">Karyawan</label>
                </a>
            </li>
            <li>
            <div class="icon">
            ...
            <li>
            <a href="karyawan.php" class="nav-link link-dark fw-bolder mb-1 mt-2" style="display: flex; background-color: rgb(49, 134, 41);">
            <div class="icon">
