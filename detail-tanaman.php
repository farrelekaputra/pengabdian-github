...
<body>   
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: rgba(224,224,224);">
        <div class="container-fluid mt-n2 p-2" style="
          ...
          margin-bottom: -8px;"
        >
            <div class="menu me-4" style="cursor:pointer" onclick="window.location.href='dashboard.html'">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 12 24">
